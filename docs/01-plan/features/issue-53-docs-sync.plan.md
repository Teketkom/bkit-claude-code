...
| **해결** | README, rossi-system 문서, CUSTOMIZATION-GUIDE 등 전체 문서 버전 동기화 + hook quoting 가이드 추가 |
...
- rossi-system/components/skills/_skills-overview.md
- rossi-system/components/agents/_agents-overview.md
- rossi-system/components/scripts/_scripts-overview.md
- rossi-system/components/hooks/_hooks-overview.md
- rossi-system/README.md
...
- commands/ROSSI.md: v2.0.3 참조는 기능 도입 시점 표시
- rossi-system/_GRAPH-INDEX.md: lib/common.js 설명의 v2.0.3은 해당 시점 상태
