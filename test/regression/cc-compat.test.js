 ...
 * CC-001~005: CC v2.1.78+ features used (PLUGIN_DATA, agent frontmatter)
...
// ============================================================
console.log('--- CC v2.1.78+ Features ---');

// CC-001: plugin.json engines requires >=2.1.78
assert('CC-001', pluginJson.engines && pluginJson.engines['claude-code'] &&
  pluginJson.engines['claude-code'].includes('2.1.78'),
  `plugin.json engines.claude-code = "${pluginJson.engines?.['claude-code']}" (includes 2.1.78)`);
...
// CC-003: All agents have model field (v2.1.78 frontmatter)
...
assert('CC-003', allHaveModel,
  'All agents have model field (v2.1.78 native frontmatter)');

// CC-004: All agents have effort field (v2.1.78 frontmatter)
...
assert('CC-004', allHaveEffort,
  'All agents have effort field (v2.1.78 native frontmatter)');

// CC-005: All agents have maxTurns field (v2.1.78 frontmatter)
...
assert('CC-005', allHaveMaxTurns,
  'All agents have maxTurns field (v2.1.78 native frontmatter)');
