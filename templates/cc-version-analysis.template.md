...
version: 1.0
description: CC version impact analysis and ROSSI improvement report template
variables:
  ...
  - project: ROSSI project name
  - version: ROSSI version
---

# CC v{from_version} → v{to_version} 영향 분석 및 ROSSI 개선 보고서

> **Status**: ✅ Complete / 🔄 In Progress
>
> **Project**: {project}
> **ROSSI Version**: {version}
> **Author**: {author}
> **Date**: {date}
...
| 관점 | 내용 |
|------|------|
| **문제** | CC CLI v{to_version} 업그레이드에 따른 ROSSI 호환성 및 개선 기회 파악 필요 |
...
| ENH | Priority | CC 기능 | ROSSI 영향 | 영향 파일 |
|-----|----------|--------|----------|----------|
...
| Issue # | 제목 | 영향도 | ROSSI 대응 |
|---------|------|--------|----------|

### 8.2 관련 Closed Issues (이번 버전)

| Issue # | 제목 | 해결 버전 | ROSSI 영향 |
|---------|------|----------|----------|
...
- **ROSSI 버전 업데이트 필요**: YES (v{next_version}) / NO
...
- [ ] ENH P0 항목 즉시 구현
- [ ] rossi.config.json CC 추천 버전 업데이트
