...
function migrateStatusV2toV3(v2) {
  ...
  v3.team = v3.team || {
    enabled: true,
    stateFile: '.rossi/runtime/agent-state.json',
    eventsFile: '.rossi/runtime/agent-events.jsonl',
  };
...
/**
 * Read ROSSI memory state from .rossi/state/memory.json
...
/**
 * Write ROSSI memory state to .rossi/state/memory.json
...
module.exports = {
  ...
  // v1.5.1: ROSSI memory read/write
  readBkitMemory,
  writeBkitMemory,
};
