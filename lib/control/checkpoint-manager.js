 ...
 *
 * Storage layout:
 *   .rossi/checkpoints/index.json        — checkpoint index
 *   .rossi/checkpoints/cp-{timestamp}.json — individual checkpoint snapshots
 *
...
const CHECKPOINTS_DIR = '.rossi/checkpoints';
const INDEX_FILE = 'index.json';
const PDCA_STATUS_PATH = '.rossi/state/pdca-status.json';
