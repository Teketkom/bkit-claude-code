 ...
 * destructive operation handling, and rossi.config.json integration.
 */
...
function _getControlStatePath() {
  ...
  return path.join(PROJECT_DIR, '.rossi', 'runtime', 'control-state.json');
}
...
function getCurrentLevel() {
  ...
  const envLevel = process.env.ROSSI_AUTOMATION_LEVEL;
  if (envLevel != null) {
  ...
  const legacyEnv = process.env.ROSSI_PDCA_AUTOMATION;
