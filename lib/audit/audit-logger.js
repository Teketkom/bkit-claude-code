 ...
 * @version 2.0.0
 *
 * Records all significant actions in ROSSI for transparency and traceability.
 * Storage: .rossi/audit/YYYY-MM-DD.jsonl (one JSON object per line)
 *
 * Design Reference: docs/02-design/features/rossi-v200-controllable-ai.design.md
 */
 ...
 * @returns {string} Absolute path to .rossi/audit/
 */
function getAuditDir() {
  return path.join(getPlatform().PROJECT_DIR, '.rossi', 'audit');
}
