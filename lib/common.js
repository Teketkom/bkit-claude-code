/**
 * ROSSI Common Module - Migration Bridge
 * @module lib/common
 * @version 1.6.0
 *
...
module.exports = {
  ...
  TOOLSEARCH_TTL: core.TOOLSEARCH_TTL,
  getToolSearchCache: core.getToolSearchCache,
  setToolSearchCache: core.setToolSearchCache,
  ...
  REQUIRED_SECTIONS: pdca.REQUIRED_SECTIONS,
  detectDocumentType: pdca.detectDocumentType,
  extractSections: pdca.extractSections,
  isPlanPlus: pdca.isPlanPlus,
  validateDocument: pdca.validateDocument,
  formatValidationWarning: pdca.formatValidationWarning,
