...
/**
 * Agent trigger patterns for 9 languages
 */
const AGENT_TRIGGER_PATTERNS = {
  ...
  'cto-lead': {
    ...
    ru: ['команда', 'лид проекта', 'руководитель', 'CTO', 'режим команды', 'координация']
  },
  'pm-lead': {
...
/**
 * Skill trigger patterns for 9 languages
 */
const SKILL_TRIGGER_PATTERNS = {
  starter: {
    ...
    ru: ['статический сайт', 'простой сайт', 'лендинг', 'портфолио']
  },
  dynamic: {
    ...
    ru: ['логин', 'фуллстек', 'база данных', 'авторизация', 'бэкенд']
  },
  enterprise: {
    ...
    ru: ['микросервисы', 'кубернетис', 'терраформ', 'архитектура']
  },
  'mobile-app': {
    ...
    ru: ['мобильное приложение', 'react native', 'flutter', 'ios', 'android']
  }
};
